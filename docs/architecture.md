...
**Still not implemented**, by design: AI, integrations, and auth. Phases 1–7 exist to give those later phases trustworthy source data, a trustworthy engine, a safe what-if layer, a decision-support layer, a data-portability boundary, and a skill/capability dimension on top of it — see [docs/adr/0001-phase-0-bootstrap.md](./adr/0001-phase-0-bootstrap.md) for the original bootstrap.
