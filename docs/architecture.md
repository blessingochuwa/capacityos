...
**Still not implemented**, by design: the dashboard, scenario planning, skills/bottleneck analysis, AI, integrations, and auth. Phase 1 and 2 exist to give those later phases trustworthy source data and a trustworthy engine — see [docs/adr/0001-phase-0-bootstrap.md](./adr/0001-phase-0-bootstrap.md) for the original bootstrap.
