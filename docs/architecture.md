...
**Still not implemented**, by design: import/export, skills/bottleneck analysis, AI, integrations, and auth. Phases 1–5 exist to give those later phases trustworthy source data, a trustworthy engine, a safe what-if layer, and a decision-support layer on top of it — see [docs/adr/0001-phase-0-bootstrap.md](./adr/0001-phase-0-bootstrap.md) for the original bootstrap.
