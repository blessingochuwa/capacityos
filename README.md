...
> **Status:** Phase 5 — domain foundation, a deterministic capacity engine, a read-only capacity dashboard, scenario/what-if planning, and operational insights (prioritized, explainable capacity signals) are implemented. Import/export, skills/bottleneck analysis, AI, integrations, and auth do not exist yet. See [docs/domain-concepts.md](./docs/domain-concepts.md) for what the domain entities mean and [docs/adr/](./docs/adr/) for the decisions behind them.
