...
> **Status:** Phase 4 — domain foundation, a deterministic capacity engine, a read-only capacity dashboard, and scenario/what-if planning are implemented. Skills/bottleneck analysis, AI, integrations, and auth do not exist yet. See [docs/domain-concepts.md](./docs/domain-concepts.md) for what the domain entities mean and [docs/adr/](./docs/adr/) for the decisions behind them.
