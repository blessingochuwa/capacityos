...
class AvailabilityExceptionService:
    ...
    def create(
        self, organization_id: uuid.UUID, data: AvailabilityExceptionCreate
    ...
    def get(self, organization_id: uuid.UUID, exception_id: uuid.UUID) -> AvailabilityException:
        exception = self.repository.get(exception_id, organization_id)
    ...
    def list(
        ...
        *,
        ...
        return self.repository.list_filtered(
            organization_id, person_id=person_id, limit=limit, offset=offset
        )

    def update(
        self, organization_id: uuid.UUID, exception_id: uuid.UUID, data: AvailabilityExceptionUpdate
    ) -> AvailabilityException:
    ...
    def delete(self, organization_id: uuid.UUID, exception_id: uuid.UUID) -> None:
        self.repository.delete(self.get(organization_id, exception_id))
